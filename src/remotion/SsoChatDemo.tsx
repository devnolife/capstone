    ...
    <AbsoluteFill className="*:select-none" style={{ opacity: fadeOut }}>
      <div className="absolute inset-0 z-1 flex flex-col items-center justify-center px-4">
        <div className="mb-3 flex scale-75 items-start gap-2" style={popStyle(question1Pop)}>
          <CasperAvatar />
          <MemoryMinibar
            question="Apakah repo kami sudah siap direview?"
            source="Dari review sebelumnya"
            answer="Belum, masih ada catatan revisi fungsionalitas."
        ...
        >
          ...
          <span>Revisi ditanggapi</span>
        </div>
        <div className="flex items-start gap-2" style={popStyle(question2Pop)}>
          <CasperAvatar />
          <MemoryMinibar
            question="Apakah repo kami sudah siap direview?"
            source="Berdasarkan repository tim-umkm/capstone"
            answer="Sudah, semua catatan revisi telah ditanggapi."
