    ...
    <section className="md:px-4 lg:px-8">
      <div className="mx-auto max-w-(--breakpoint-xl) pt-12 pb-10 text-center max-md:px-6 md:pb-20">
        <div className="mb-8">
          ...
          >
            Bangun produk nyata, biarkan progresnya terpantau
          </h1>
          <p data-hero-item className="text-app-secondary-invert mx-auto mb-2 max-w-xl text-lg">
            Dari repo GitHub sampai presentasi akhir. Capstone menghubungkan repository,
            persyaratan, dan review dosen penguji dalam satu alur.
          </p>
          <span
            data-hero-item
        ...
        <div data-hero-item className="inline-flex items-center gap-3 max-md:flex-col md:gap-2">
          <a
            href="/demo"
            className="focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 inline-flex shrink-0 items-center justify-center gap-2 border-transparent font-medium whitespace-nowrap transition-all outline-none focus-visible:ring-[3px] active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 bg-background hover:bg-accent hover:text-accent-foreground dark:border-input dark:bg-input/30 dark:hover:bg-input/50 border shadow-xs h-10 px-6 has-[>svg]:px-4 rounded-full text-base"
          >
