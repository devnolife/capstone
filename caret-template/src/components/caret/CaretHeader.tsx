...
const LANGUAGES = ["English", "한국어", "日本語"] as const;
...
export function CaretHeader() {
  ...
  return (
    <div
      data-hero-header
      className={cn(
        "bg-background fixed top-0 left-0 z-50 w-full border-b px-6",
    ...
    >
      <nav className="mx-auto flex h-14 max-w-(--breakpoint-xl) grid-cols-2 items-center justify-between gap-2">
        ...
        <div className="flex grow gap-1 max-md:hidden md:px-7">
          ...
          <a className={navPillClass} href="https://caret.so/en/pricing">
            Pricing
          </a>
          <a className={navPillClass} href="https://caret.so/en/changelog">
            Changelog
          </a>
        </div>
