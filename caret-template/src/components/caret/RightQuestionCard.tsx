...
type Keyword = "keep growing" | "100K";
...
const QUESTION_PREFIX = "100K a year. But it's ";
const QUESTION_EMPHASIS = "keep growing";
...
export function RightQuestionCard() {
  ...
  const [keyword, setKeyword] = useState<Keyword>("keep growing");
  ...
  const handlePillClick = useCallback(
    (pill: PillId) => {
      ...
      setActivePill(pill);
      setKeyword((prev) => (prev === "keep growing" ? "100K" : "keep growing"));
      ...
      <div className="flex grow flex-col px-8 py-7">
        ...
        <div className="text-app-secondary-invert grow text-base text-pretty md:text-lg md:leading-snug">
          <div className="flex h-full flex-col">
            <p>Caret picks up on context and suggests follow-up questions to keep the conversation moving.</p>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 p-4 md:gap-4 md:p-8">
          <div className="w-full max-w-md rounded-xl bg-zinc-900/90 p-4 shadow-2xl backdrop-blur-sm md:rounded-2xl md:p-6">
            <div className="mb-3 flex items-start gap-2 md:mb-4 md:gap-3">
              ...
              <div className="text-xs text-zinc-400 md:text-sm">Signal</div>
            </div>
            <div className="space-y-2 md:space-y-3">
              ...
              >
                ...
                <p>What does that revenue trajectory tell us about their growth challenges?</p>
              </motion.div>
            </div>
          </div>
          <motion.button
