...
export function LiveSuggestionSection() {
  return (
    <section className="md:px-8 -my-px md:border-y md:border-zinc-800">
      <SectionLabelBar left="[01] LIVE SUGGESTION" right="/ FEATURES" />
      <div className="px-6 md:px-16 lg:px-24 xl:px-40 -my-px border border-zinc-800 max-md:border-x-0 bg-repeat bg-[url(/images/caret/bg-pattern-slash.svg)]">
        <div className="bg-background mx-auto w-full max-w-(--breakpoint-lg)">
          <div data-reveal className="-my-px border border-zinc-800">
            <h3 className="font-display mx-auto max-w-2xl px-6 py-12 text-center text-2xl leading-tight font-medium md:text-3xl md:leading-9">
              Caret gives you <ShimmerText>live suggestions</ShimmerText> during meetings. Never
