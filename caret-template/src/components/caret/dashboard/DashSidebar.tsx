...
const NAV = [
  { label: "Overview", icon: Star7Icon, active: true },
  { label: "Meetings", icon: MessageCircleIcon, active: false },
  { label: "Insights", icon: GraduationHatIcon, active: false },
  { label: "Integrations", icon: GitMergeIcon, active: false },
  { label: "Settings", icon: HelpCircleIcon, active: false },
];
